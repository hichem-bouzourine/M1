...
import antlr4.ILPMLgrammar2017Listener;
import antlr4.ILPMLgrammar2017Parser.SwitchContext;

import static antlr4.ILPMLgrammar2017Parser.*;

public class ILPMLListener implements ILPMLgrammar2017Listener {
	...
	public void exitSwitch(SwitchContext ctx) {
		ctx.node = factory.newSwitch(
				ctx.initialCondition.node,
				toExpressions(ctx.conds),
				toExpressions(ctx.evals),
				(ctx.defaultExpr == null) ? null : ctx.defaultExpr.node);
	}
