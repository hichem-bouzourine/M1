...
import antlr4.ILPMLgrammar2016Listener;
import static antlr4.ILPMLgrammar2016Parser.*;

public class ILPMLListener implements ILPMLgrammar2016Listener {
	...
	public void exitInvocation(
		...
		ctx.node = factory.newInvocation(
				...
				toBindings(ctx.names, ctx.nargs));
	}
