...
import antlr4.ILPMLgrammar2020Listener;
import antlr4.ILPMLgrammar2020Parser.SequenceNContext;

import static antlr4.ILPMLgrammar2020Parser.*;

public class ILPMLListener implements ILPMLgrammar2020Listener {
	...
	public void exitSequenceN(SequenceNContext ctx) {
		ctx.node = factory.newSequenceN(ctx.firstExpr.node, toExpressions(ctx.exprs));
	}
