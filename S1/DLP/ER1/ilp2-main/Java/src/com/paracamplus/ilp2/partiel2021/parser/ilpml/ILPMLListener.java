...
import antlr4.ILPMLgrammar2021Listener;
import antlr4.ILPMLgrammar2021Parser.AlternativeContext;
import antlr4.ILPMLgrammar2021Parser.BinaryContext;
import antlr4.ILPMLgrammar2021Parser.BindingContext;
import antlr4.ILPMLgrammar2021Parser.BlockRangeContext;
import antlr4.ILPMLgrammar2021Parser.ConstFalseContext;
import antlr4.ILPMLgrammar2021Parser.ConstFloatContext;
import antlr4.ILPMLgrammar2021Parser.ConstIntegerContext;
import antlr4.ILPMLgrammar2021Parser.ConstStringContext;
import antlr4.ILPMLgrammar2021Parser.ConstTrueContext;
import antlr4.ILPMLgrammar2021Parser.ExprContext;
import antlr4.ILPMLgrammar2021Parser.GlobalFunDefContext;
import antlr4.ILPMLgrammar2021Parser.InvocationContext;
import antlr4.ILPMLgrammar2021Parser.LoopContext;
import antlr4.ILPMLgrammar2021Parser.ProgContext;
import antlr4.ILPMLgrammar2021Parser.SequenceContext;
import antlr4.ILPMLgrammar2021Parser.UnaryContext;
import antlr4.ILPMLgrammar2021Parser.VariableAssignContext;
import antlr4.ILPMLgrammar2021Parser.VariableContext;

public class ILPMLListener implements ILPMLgrammar2021Listener {
	...
	@Override
	public void enterBlockRange(BlockRangeContext ctx) {
	}

	@Override
	public void exitBlockRange(BlockRangeContext ctx) {
		ctx.node = factory.newBlockRange(
				toBindingRanges(ctx.vars, ctx.l, ctx.h, ctx.vals), ctx.body.node);
	}

	protected IASTblockRange.IASTrangeBinding[] toBindingRanges(List<Token> vars, List<ExprContext> low,
			List<ExprContext> high, List<ExprContext> exprs) {
		if (vars == null)
			return new IASTblockRange.IASTrangeBinding[0];
		IASTblockRange.IASTrangeBinding[] r = new IASTblockRange.IASTrangeBinding[exprs.size()];
		int pos = 0;
		for (Token v : vars) {
