...
import antlr4.ILPMLgrammarPartielListener;
import antlr4.ILPMLgrammarPartielParser.*;

public class ILPMLListener implements ILPMLgrammarPartielListener {
	...
	public void exitFreeze(FreezeContext ctx) {
		ctx.node = factory.newFreeze(ctx.fun.node, toExpressions(ctx.args));
	}
