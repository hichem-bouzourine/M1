// Generated from /home/ubuntu/Desktop/M1/S1/DLP/ER1/ilp2-main/Java/src/com/paracamplus/ilp2/ilp2partiel/ANTLRGrammars/ILPMLgrammarPartiel.g4 by ANTLR 4.13.1
...
public class ILPMLgrammarPartielParser extends Parser {
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'then'", "'else'", "'freeze'", "'frozen'", "'while'", "'do'"
		};
	}
	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 265363128520L) != 0)) {
				{
				{
				setState(15);
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				setState(60);
				((UnaryContext)_localctx).arg = expr(19);
				}
				break;
			case 3:
				{
			...
			case 9:
				...
				match(T__25);
				setState(81);
				((BindingContext)_localctx).body = expr(6);
				}
				break;
			case 10:
				{
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 7:
						...
						_errHandler.sync(this);
						_la = _input.LA(1);
						if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 265363128520L) != 0)) {
							{
							setState(138);
