...
import antlr4.ILPgrammarExam2021Listener;
import antlr4.ILPgrammarExam2021Parser.ListContext;

import static antlr4.ILPgrammarExam2021Parser.*;

public class ILPMLListener implements ILPgrammarExam2021Listener {
	...
	public void exitList(ListContext ctx) {
		...
		if (ctx.cond != null)
			cond = ctx.cond.node;
		IASTvariable myVar = factory.newVariable(ctx.var.getText());

		ctx.node = factory.newList(ctx.body.node, myVar, ctx.max.node, cond);
	}
