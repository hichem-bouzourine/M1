// Generated from /home/ubuntu/Desktop/M1/S1/DLP/ER2/ILP4/Java/src/com/paracamplus/ilp4/exam2019/ANTLRGrammars/ILPMLgrammar2019.g4 by ANTLR 4.13.1
...
public class ILPMLgrammar2019Parser extends Parser {
	...
	public static final int
		...
		T__45=46, IDENT=47, INT=48, FLOAT=49, STRING=50, ESC=51, LINE_COMMENT=52, 
		COMMENT=53, SPACE=54;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'('", "')'", "'function'", "'autoclose'", "'='", "'in'", "'self'", "'super'", 
			"'.'", "'new'", "'-'", "'!'", "'*'", "'/'", "'%'", "'+'", "'<'", "'<='", 
			"'>'", "'>='", "'=='", "'!='", "'&'", "'|'", "'^'", "'true'", "'false'", 
			"'let'", "'and'", "'if'", "'then'", "'else'", "'while'", "'do'", "'try'", 
			"'catch'", "'finally'", "'lambda'"
		};
	}
	...
	@Override
	public String getGrammarFileName() { return "ILPMLgrammar2019.g4"; }
	...
	public ILPMLgrammar2019Parser(TokenStream input) {
		super(input);
	...
	public static class ProgContext extends ParserRuleContext {
		...
		public TerminalNode EOF() { return getToken(ILPMLgrammar2019Parser.EOF, 0); }
	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2192821324716544L) != 0)) {
				{
				{
				setState(23);
	...
	public static class ClassDefContext extends ParserRuleContext {
		...
		public List<TerminalNode> IDENT() { return getTokens(ILPMLgrammar2019Parser.IDENT); }
		public TerminalNode IDENT(int i) {
			return getToken(ILPMLgrammar2019Parser.IDENT, i);
		}
	...
	public static class NewContext extends ExprContext {
		...
		public TerminalNode IDENT() { return getToken(ILPMLgrammar2019Parser.IDENT, 0); }
		public List<ExprContext> expr() {
			return getRuleContexts(ExprContext.class);
		}
		public ExprContext expr(int i) {
	...
	public static class ConstFloatContext extends ExprContext {
		...
		public TerminalNode FLOAT() { return getToken(ILPMLgrammar2019Parser.FLOAT, 0); }
	...
	public static class ConstIntegerContext extends ExprContext {
		...
		public TerminalNode INT() { return getToken(ILPMLgrammar2019Parser.INT, 0); }
	...
	public static class ConstStringContext extends ExprContext {
		...
		public TerminalNode STRING() { return getToken(ILPMLgrammar2019Parser.STRING, 0); }
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				match(T__11);
				setState(137);
				((AutocloseContext)_localctx).var = match(IDENT);
				setState(138);
				match(T__12);
				setState(139);
				((AutocloseContext)_localctx).val = expr(0);
				setState(140);
				match(T__13);
				setState(141);
				((AutocloseContext)_localctx).body = expr(28);
				}
				break;
			case 3:
				{
			...
			case 5:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2192821324716544L) != 0)) {
					{
					setState(148);
