...
import antlr4.ILPMLgrammar2021Parser.MatchWithContext;
import antlr4.ILPMLgrammar2021Parser.TagContext;

import static antlr4.ILPMLgrammar2021Parser.*;
...
public class ILPMLListener implements ILPMLgrammar2021Listener {
	...
	@Override
	public void enterMatchWith(MatchWithContext ctx) {
	}
	...
	@Override
	public void exitMatchWith(MatchWithContext ctx) {
		ctx.node = factory.newMatchWith(
				ctx.somme.node,
				ctx.tag.getText(),
				toVariables(ctx.vars, false),
				ctx.consequence.node,
