// Generated from /home/hichem/Desktop/M1/S1/DLP/ER2/ILP4/Java/src/com/paracamplus/ilp4/exam2018/ANTLRGrammars/ILPMLgrammar2018.g4 by ANTLR 4.13.1
...
public class ILPMLgrammar2018Parser extends Parser {
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'('", "')'", "'function'", "'self'", "'super'", "'super_with_args'", 
			"'.'", "'new'", "'-'", "'!'", "'*'", "'/'", "'%'", "'+'", "'<'", "'<='", 
			"'>'", "'>='", "'=='", "'!='", "'&'", "'|'", "'^'", "'true'", "'false'", 
			"'let'", "'='", "'and'", "'in'", "'if'", "'then'", "'else'", "'while'", 
	...
	@Override
	public String getGrammarFileName() { return "ILPMLgrammar2018.g4"; }
	...
	public ILPMLgrammar2018Parser(TokenStream input) {
		super(input);
	...
	public static class ProgContext extends ParserRuleContext {
		...
		public TerminalNode EOF() { return getToken(ILPMLgrammar2018Parser.EOF, 0); }
	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2192731128953344L) != 0)) {
				{
				{
				setState(23);
	...
	public static class ClassDefContext extends ParserRuleContext {
		...
		public List<TerminalNode> IDENT() { return getTokens(ILPMLgrammar2018Parser.IDENT); }
		public TerminalNode IDENT(int i) {
			return getToken(ILPMLgrammar2018Parser.IDENT, i);
		}
	...
	public static class NewContext extends ExprContext {
		...
		public TerminalNode IDENT() { return getToken(ILPMLgrammar2018Parser.IDENT, 0); }
		public List<ExprContext> expr() {
			return getRuleContexts(ExprContext.class);
		}
		public ExprContext expr(int i) {
	...
	public static class ConstFloatContext extends ExprContext {
		...
		public TerminalNode FLOAT() { return getToken(ILPMLgrammar2018Parser.FLOAT, 0); }
	...
	public static class ConstIntegerContext extends ExprContext {
		...
		public TerminalNode INT() { return getToken(ILPMLgrammar2018Parser.INT, 0); }
	...
	public static class ConstStringContext extends ExprContext {
		...
		public TerminalNode STRING() { return getToken(ILPMLgrammar2018Parser.STRING, 0); }
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case 4:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2192731128953344L) != 0)) {
					{
					setState(140);
					((SuperWithArgsContext)_localctx).expr = expr(0);
					((SuperWithArgsContext)_localctx).args.add(((SuperWithArgsContext)_localctx).expr);
					}
				}
