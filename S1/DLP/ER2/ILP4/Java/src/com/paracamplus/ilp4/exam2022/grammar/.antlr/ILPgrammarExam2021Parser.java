// Generated from /home/ubuntu/Desktop/M1/S1/DLP/ER2/ILP4/Java/src/com/paracamplus/ilp4/exam2021/grammar/ILPgrammarExam2021.g4 by ANTLR 4.13.1
...
public class ILPgrammarExam2021Parser extends Parser {
	...
	public static final int
		...
		T__45=46, T__46=47, T__47=48, T__48=49, IDENT=50, INT=51, FLOAT=52, STRING=53, 
		ESC=54, LINE_COMMENT=55, COMMENT=56, SPACE=57;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'('", "')'", "'function'", "'['", "'for'", "'in'", "'range'", "'if'", 
			"']'", "'self'", "'super'", "'.'", "'new'", "'-'", "'!'", "'*'", "'/'", 
			"'%'", "'+'", "'<'", "'<='", "'>'", "'>='", "'=='", "'!='", "'&'", "'|'", 
			"'^'", "'true'", "'false'", "'let'", "'='", "'and'", "'then'", "'else'", 
			"'while'", "'do'", "'try'", "'catch'", "'finally'", "'lambda'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, "IDENT", "INT", "FLOAT", "STRING", "ESC", "LINE_COMMENT", 
			"COMMENT", "SPACE"
		};
	}
	...
	@Override
	public String getGrammarFileName() { return "ILPgrammarExam2021.g4"; }
	...
	public ILPgrammarExam2021Parser(TokenStream input) {
		super(input);
	...
	public static class ProgContext extends ParserRuleContext {
		...
		public TerminalNode EOF() { return getToken(ILPgrammarExam2021Parser.EOF, 0); }
	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 17540371574495744L) != 0)) {
				{
				{
				setState(23);
	...
	public static class ClassDefContext extends ParserRuleContext {
		...
		public List<TerminalNode> IDENT() { return getTokens(ILPgrammarExam2021Parser.IDENT); }
		public TerminalNode IDENT(int i) {
			return getToken(ILPgrammarExam2021Parser.IDENT, i);
		}
	...
	public static class NewContext extends ExprContext {
		...
		public TerminalNode IDENT() { return getToken(ILPgrammarExam2021Parser.IDENT, 0); }
		public List<ExprContext> expr() {
			return getRuleContexts(ExprContext.class);
		}
		public ExprContext expr(int i) {
	...
	public static class ConstFloatContext extends ExprContext {
		...
		public TerminalNode FLOAT() { return getToken(ILPgrammarExam2021Parser.FLOAT, 0); }
	...
	public static class ConstIntegerContext extends ExprContext {
		...
		public TerminalNode INT() { return getToken(ILPgrammarExam2021Parser.INT, 0); }
	...
	public static class ConstStringContext extends ExprContext {
		...
		public TerminalNode STRING() { return getToken(ILPgrammarExam2021Parser.STRING, 0); }
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				match(T__11);
				setState(137);
				((ListContext)_localctx).body = expr(0);
				setState(138);
				match(T__12);
				setState(139);
				((ListContext)_localctx).var = match(IDENT);
				setState(140);
				match(T__13);
				setState(141);
				match(T__14);
				...
				match(T__8);
				setState(143);
				((ListContext)_localctx).max = expr(0);
				setState(144);
				match(T__9);
				setState(147);
				_errHandler.sync(this);
				...
				if (_la==T__15) {
					...
					match(T__15);
					setState(146);
					((ListContext)_localctx).cond = expr(0);
					}
				}
			...
			case 5:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 17540371574495744L) != 0)) {
					{
					setState(156);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 5:
						...
						setState(260);
						((BinaryContext)_localctx).op = match(T__33);
						setState(261);
