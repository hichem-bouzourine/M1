// Generated from /home/hichem/Desktop/M1/S1/DLP/ER2/ILP4/Java/src/com/paracamplus/ilp4/exam2021/ANTLRGrammars/ILPMLgrammar2021.g4 by ANTLR 4.13.1
...
public class ILPMLgrammar2021Parser extends Parser {
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'-'", "'!'", "'*'", "'/'", "'%'", "'+'", "'<'", "'<='", "'>'", "'>='", 
			"'=='", "'!='", "'&'", "'|'", "'^'", "'true'", "'false'", "'let'", "'='", 
			"'and'", "'in'", "'if'", "'then'", "'else'", "'match'", "'with'", "'while'", 
	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 8772208709564928L) != 0)) {
				{
				{
				setState(23);
	...
	@SuppressWarnings("CheckReturnValue")
	public static class MatchWithContext extends ExprContext {
		public ExprContext somme;
		public Token tag;
		public Token IDENT;
		public List<Token> vars = new ArrayList<Token>();
		...
		public MatchWithContext(ExprContext ctx) { copyFrom(ctx); }
	}
	@SuppressWarnings("CheckReturnValue")
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 8772208709564928L) != 0)) {
					{
					setState(139);
					((TagContext)_localctx).expr = expr(0);
					((TagContext)_localctx).args.add(((TagContext)_localctx).expr);
					}
				}
			...
			case 6:
				...
				setState(167);
				((UnaryContext)_localctx).arg = expr(22);
				}
				break;
			case 7:
				{
			...
			case 13:
				...
				match(T__36);
				setState(188);
				((BindingContext)_localctx).body = expr(9);
				}
				break;
			case 14:
				{
			...
			case 15:
				...
				match(T__34);
				setState(200);
				((VariableAssignContext)_localctx).val = expr(6);
				}
				break;
			case 16:
				{
				...
				match(T__40);
				setState(202);
				((MatchWithContext)_localctx).somme = expr(0);
				setState(203);
				match(T__41);
				setState(204);
				((MatchWithContext)_localctx).tag = match(IDENT);
				setState(205);
				match(T__8);
				setState(207);
				_errHandler.sync(this);
				...
				if (_la==IDENT) {
					{
					setState(206);
					((MatchWithContext)_localctx).IDENT = match(IDENT);
					((MatchWithContext)_localctx).vars.add(((MatchWithContext)_localctx).IDENT);
					}
				}
				...
				match(T__38);
				setState(218);
				((MatchWithContext)_localctx).consequence = expr(0);
				setState(219);
				match(T__39);
				setState(220);
				((MatchWithContext)_localctx).alternant = expr(5);
				}
				break;
			case 17:
				{
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(269);
						((BinaryContext)_localctx).arg2 = expr(22);
						}
						break;
					case 2:
						{
					...
					case 7:
						...
						match(T__34);
						setState(289);
						((WriteFieldContext)_localctx).val = expr(8);
						}
						break;
					case 8:
						{
